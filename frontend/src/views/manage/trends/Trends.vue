...
import BulletinAdd from './TrendsAdd.vue'
import BulletinEdit from './TrendsEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/price-trends/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/price-trends/page', {
        ...params
      }).then((r) => {
