...
import BulletinAdd from './ConfigAdd.vue'
import BulletinEdit from './ConfigEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/price-config/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/price-config/page', {
        ...params
      }).then((r) => {
